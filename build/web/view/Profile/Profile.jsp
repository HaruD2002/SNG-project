                                        ...
                                        <div class="card-text">
                                            <c:choose>  
                                                ...
                                                <c:when test = "${userAccount.getID() ne user.getID()}"> 
                                                    <c:if test="${isFriend eq 1}">  
                                                        <div class="dropdown">
                                                            <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton2" data-bs-toggle="dropdown" aria-expanded="false" style="background-color: blue; width: 100%; height: 100%">
                                                                Friend
                                                            </button>
                                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton2">
                                                                <li><a class="dropdown-item" href="chat">Message</a></li>
                                                                <li><a class="dropdown-item" href="deleteFriend" value="${userAccount.getID()}" name="friend">Remove Friend</a></li>
                                                            </ul>
                                                        </div>
                                                    </c:if>
                                                    <c:if test="${isFriend eq 0}">
                                                        <button class="btn btn-secondary" style="background-color:green;" type="submit">Accepted </button>
                                                        <button class="btn btn-secondary" style="background-color:gray; "type="submit" >Cancel </button>
                                                    </c:if>
                                                    <c:if test="${isFriend eq -1}">            
                                                        <form action="addFriend" method="get">
                                                            <button class="btn btn-secondary" style="background-color:green;" href="addFriend" name="Friendcode" value="${userAccount.getID()}" type="submit">Add Friend</button>
                                                        </form>
                                                    </c:if>
                                                </c:when>
                                                <c:otherwise>  
