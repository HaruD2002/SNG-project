...
public class UserDao {
    ...
    public User getPassword(Integer Id) {
        ...
        try {
            ...
            rs = stm.executeQuery();
            if (rs.next()) {
                upass.setID(rs.getInt("ID"));
                upass.setPassword(rs.getString("password"));
                return upass;
            }
        } catch (Exception ex) {
            Logger.getLogger(UserDao.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String[] args) {
        ...
        User currentpassword = db.getPassword(2);
        String new_password = "121";
        User thisUser = db.Login("test","1", 1);
        
        if(currentpassword.getPassword().equals(thisUser.getPassword())){
            db.changePassword(2, new_password);
        }else{
