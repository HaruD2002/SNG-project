...
public class FriendDao {
    ...
    public int isFriend(Integer Id, ArrayList<Friend> userFriend) {
        for (int i = 0; i < userFriend.size(); i++) {
            if (userFriend.get(i).getUserID2().getID() == Id) {
                return 1;
            }
        }
        return 0;
    ...
    public static void main(String[] args) {
        ...
        int isFriend;
        int isFriends = db.isFriend(1,db.getFriend(2,1));
        int isPending = db.isFriend(1,db.getFriend(2,0));
        if(isFriends == 1){
        isFriend = 1;
        }else{
            if(isPending ==1){
    ...
    public void pendingFriend(Integer id1, Integer id2, Date time) {
    ...
    public void removeFriend(Integer id,Integer id2) {
